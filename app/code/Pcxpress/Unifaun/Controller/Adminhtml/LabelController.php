...
class LabelController extends \Magento\Backend\App\Action
{
	...
	{
		$this->loadLayout()
				->_setActiveMenu('unifaun/unifaun_label')
				->_addBreadcrumb(__('Pcxpress Unifaun: Labels'), __('Label Manager'));
