...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('pickuplocation');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Pcxpress\Unifaun\Model\Pickuplocation')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('unifaun/*/index');
    }
